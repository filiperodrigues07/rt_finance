...
/** Glifo do WhatsApp (verde da marca) para o cabeçalho da seção. */
function WhatsappGlyph({ className = "size-4" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="#25D366" className={className} aria-hidden>
  ...
  if (status && !status.enabled) {
    return (
      <CollapsibleCard
        ...
        description="Conexão com a Evolution API"
      >
